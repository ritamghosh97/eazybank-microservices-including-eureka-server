    ...
    @Tag(
            ...
            description = "Crud Rest Api in EazyBank to perform create, update, fetch and delete operations",
            externalDocs = @ExternalDocumentation(
                    description = "Learn more about Accounts Microservice",
    ...
    public class AccountsController {
        ...
        @Operation(
                ...
                description = "A Rest Api to create new Customer and Account inside Eazybank"
        )
        ...
        @Operation(
                ...
                description = "A Rest Api to fetch Customer and Account details based on mobile number"
        )
        @ApiResponses({
                @ApiResponse(
                        responseCode = "200",
        ...
        @Operation(
                ...
                description = "Build version number of the Accounts Microservice"
        )
        @ApiResponses({
                @ApiResponse(
                        responseCode = "200",
        ...
        @Operation(
                summary = "Java Version Information",
                description = "JDK version is being used in the Accounts Microservice"
        )
        @ApiResponses({
                @ApiResponse(
                        responseCode = "200",
